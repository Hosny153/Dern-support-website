                ...
                <div class="row gy-3 overflow-hidden">
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="email" class="form-control border-0 border-bottom" style="border-radius: 10px;" name="Email" placeholder="name@example.com" required>
                      <label for="email" class="form-label">Email</label>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="password" class="form-control border-0 border-bottom rounded-0" style="border-radius: 10px;" name="Password" value="" placeholder="Password" required>
                  ...
                  <div class="col-12">
                    <div class="d-grid">
                      <button class="btn btn-primary btn-lg" style="border-radius: 10px;" type="submit">Log in</button>
                    </div>
                  </div>
                </div>
              </form>
